...
export default function MetricCard({title, value, delta}:{title:string,value:string,delta?:string}){
  return (
    <Card className="flex flex-col gap-2 rounded-[28px] border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] p-5 shadow-[0_16px_48px_rgba(0,0,0,0.2)]">
